...
- [Qwen3-8B: multilingual instruction/reasoning model](https://huggingface.co/Qwen/Qwen3-8B)
- [Aya Expanse 8B: multilingual generation model](https://huggingface.co/CohereLabs/aya-expanse-8b)
- [multilingual-e5-large: multilingual sentence embeddings](https://huggingface.co/intfloat/multilingual-e5-large)
- [mDeBERTa-v3-base-XNLI multilingual NLI](https://huggingface.co/MoritzLaurer/mDeBERTa-v3-base-xnli-multilingual-nli-2mil7)
